...
4- Add basic controllable mecha entity with non-modular model renderer and modular stats (BIG ONE) (no inventory for now) --DONE
5- Implement actually designed modules
6- make renderer modular (VERY BIG ONE)
7- add mecha inventory
8- add some more content
9- add mech bay (repair, disassembly, part swapping)
10- make survival friendly: recipes doability, usability in survival
11- implement size 2 (6-high, 4-wide), size 3 (8-high, 5-wide) and maybe even size 4 (10-high, 6-wide). Maybe size 0.5 (2-high, 1.5-wide)?